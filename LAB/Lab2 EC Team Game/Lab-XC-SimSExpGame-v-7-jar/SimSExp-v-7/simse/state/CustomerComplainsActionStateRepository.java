...
{
private Vector<CustomerComplainsAction> actions;

public CustomerComplainsActionStateRepository()
{
actions = new Vector<CustomerComplainsAction>();
}

public Object clone() {
try {
CustomerComplainsActionStateRepository cl = (CustomerComplainsActionStateRepository) (super.clone());
Vector<CustomerComplainsAction> clonedActions = new Vector<CustomerComplainsAction>();
for (int i = 0; i < actions.size(); i++) {
clonedActions.add((CustomerComplainsAction)actions.elementAt(i).clone());
}
...
public boolean add(CustomerComplainsAction a)
{
...
public boolean remove(CustomerComplainsAction a)
{
...
public Vector<CustomerComplainsAction> getAllActions(SSObject a)
{
Vector<CustomerComplainsAction> all = new Vector<CustomerComplainsAction>();
for(int i=0; i<actions.size(); i++)
{
CustomerComplainsAction b = actions.elementAt(i);
...
public Vector<CustomerComplainsAction> getAllActiveActions(SSObject a)
{
Vector<CustomerComplainsAction> all = new Vector<CustomerComplainsAction>();
for(int i=0; i<actions.size(); i++)
{
...
public Vector<CustomerComplainsAction> getAllInactiveActions(SSObject a)
{
Vector<CustomerComplainsAction> all = new Vector<CustomerComplainsAction>();
for(int i=0; i<actions.size(); i++)
{
...
public CustomerComplainsAction getActionWithId(int id) {
for (int i = 0; i < actions.size(); i++) {
CustomerComplainsAction act = actions.get(i);
if (act.getId() == id) {
return act;
}
}
...
for (int i = 0; i < actions.size(); i++) {
CustomerComplainsAction act = actions.elementAt(i);

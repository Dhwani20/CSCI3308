...
private Hashtable<SSObject, ImageIcon> objsToImages; // maps Objects (keys) to ImageIcons (values)
private Hashtable<JButton, SSObject> buttonsToObjs; // maps JButtons (keys) to Objects (values)
...
allIcon = new ImageIcon(ImageLoader.getImageFromURL("/simse/gui/images/all.GIF"));

// get the Border styles:
defaultBorder = new JButton().getBorder();
selectedBorder = new BevelBorder(BevelBorder.RAISED,new Color(80,80,225,255), new Color(0,0,115,255));
...
buttonsPane.setBackground(new Color(69,135,156,255)); // dark green color
JScrollPane buttonsScrollPane = new JScrollPane(buttonsPane, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED ,JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
...
// Add Logo Pane:
gbc = new GridBagConstraints(0,0,1,2,1,1,GridBagConstraints.NORTHWEST,GridBagConstraints.NONE, new Insets(0,0,0,0), 0,0);
gbl.setConstraints(logoPane,gbc);
add(logoPane);

// Add panes and labels to main pane
gbc = new GridBagConstraints(1,0,1,1,1,1, GridBagConstraints.SOUTHWEST, GridBagConstraints.NONE, new Insets(0,0,10,0), 0,0);
...
{
GridBagConstraints gbc = new GridBagConstraints(i,j,1,1,1.0,1.0,GridBagConstraints.NORTHWEST,GridBagConstraints.NONE, new Insets(2,1,0,0),0,0);

index = shift + i;
if (button == employeeButton)
{
PopupListener pListener = ((PopupListener)button[index].getMouseListeners()[1]);
...
attributePane.setObjectInFocus(objInFocus, (new ImageIcon(ImageLoader.getImageFromURL(filename))));
...
if(objs.size() > 0) // there is at least one object of the selected type
{
atLeastOneObj = true;
...
PopupListener pListener = ((PopupListener)button.getMouseListeners()[1]);
...
{
SoftwareDeveloper p = (SoftwareDeveloper)obj;
if(p.getName().equals("Robert"))
{
url = "/simse/gui/icons/chris.gif";
}
else if(p.getName().equals("Joyce"))
{
url = "/simse/gui/icons/Barbara.gif";
}
else if(p.getName().equals("Peg"))
{
url = "/simse/gui/icons/Emilyv2.gif";
}
...
{
url = "/simse/gui/icons/dourish.gif";
}
else if(p.getName().equals("Sigfreido"))
{
url = "/simse/gui/icons/boss.gif";
}
}
else if(obj instanceof Manager)
{
Manager p = (Manager)obj;
if(p.getName().equals("Chang"))
{
url = "/simse/gui/icons/mgr.png";
}
}
else if(obj instanceof CustomerRepresentative)
{
CustomerRepresentative p = (CustomerRepresentative)obj;
if(p.getName().equals("Wayne"))
{
url = "/simse/gui/icons/pirate.png";
}
}
else if(obj instanceof UserStories)
{
UserStories p = (UserStories)obj;
if(p.getName().equals("Stories"))
{
url = "/simse/gui/icons/use_case_pink.GIF";
}
}
else if(obj instanceof CustomerRep)
{
CustomerRep p = (CustomerRep)obj;
...
{
ReleasePlan p = (ReleasePlan)obj;
if(p.getName().equals("Release Plan"))
{
...
{
TheProject p = (TheProject)obj;
if(p.getName().equals("XP Project"))
{
url = "/simse/gui/icons/elmo.png";
}
}
else if(obj instanceof CurrentIterationPlan)
{
CurrentIterationPlan p = (CurrentIterationPlan)obj;
if(p.getName().equals("IterationPlan"))
{
...
{
AcceptanceTests p = (AcceptanceTests)obj;
if(p.getDescription().equals("Test cases that customers and developers agree will be the criteria for acceptance of the software"))
{
url = "/simse/gui/icons/9.gif";
}
}
else if(obj instanceof CRCCards)
{
CRCCards p = (CRCCards)obj;
if(p.getDescription().equals("Class Responsibility Collaborator Cards, a brainstorming tool for designing object-oriented software"))
{
...
{
Design p = (Design)obj;
if(p.getDescription().equals("CRC cards for this iteration's stories"))
{
...
{
UnitTestingFramework p = (UnitTestingFramework)obj;
if(p.getDescription().equals("Java-based unit testing framework"))
{
url = "/simse/gui/icons/7.gif";
}
}
else if(obj instanceof UnitTests)
{
UnitTests p = (UnitTests)obj;
if(p.getDescription().equals("Test cases for individual pieces of source code"))
{
...
{
Code p = (Code)obj;
if(p.getDescription().equals("The code for the current iteration's user stories"))
{
...
{
CodingStandard p = (CodingStandard)obj;
if(p.getDescription().equals("A standard style and format for source code"))
{
url = "/simse/gui/icons/2.gif";
}
}
else if(obj instanceof RefactoringTool)
{
RefactoringTool p = (RefactoringTool)obj;
if(p.getDescription().equals("Eclipse"))
{

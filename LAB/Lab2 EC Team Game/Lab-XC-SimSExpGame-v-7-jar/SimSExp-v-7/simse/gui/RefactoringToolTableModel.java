...
public class RefactoringToolTableModel extends AbstractTableModel
{
...
public RefactoringToolTableModel(State s)
{
state = s;
...
{
temp.add(refactoringtools.elementAt(i).getDescription());
}
if(data.size() < 1)
{
data.add(temp);
...
temp.add(numFormat.format(refactoringtools.elementAt(i).getProductivityIncreaseFactor()));
}
if(data.size() < 2)
{
data.add(temp);

...
public class ReleasePlanTableModel extends AbstractTableModel
{
...
public ReleasePlanTableModel(State s)
{
state = s;
...
{
temp.add(releaseplans.elementAt(i).getName());
}
if(data.size() < 1)
{
data.add(temp);
...
temp.add(numFormat.format(releaseplans.elementAt(i).getCompleteness()));

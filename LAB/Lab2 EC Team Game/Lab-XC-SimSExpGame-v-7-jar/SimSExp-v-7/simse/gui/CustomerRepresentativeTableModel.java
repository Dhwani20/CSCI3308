...
public class CustomerRepresentativeTableModel extends AbstractTableModel
{
...
public CustomerRepresentativeTableModel(State s)
{
state = s;
...
{
temp.add(customerrepresentatives.elementAt(i).getName());
}
if(data.size() < 1)
{
data.add(temp);

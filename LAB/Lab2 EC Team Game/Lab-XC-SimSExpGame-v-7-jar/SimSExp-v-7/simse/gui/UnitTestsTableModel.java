...
public class UnitTestsTableModel extends AbstractTableModel
{
...
public UnitTestsTableModel(State s)
{
state = s;
...
{
temp.add(unittestss.elementAt(i).getDescription());
}
if(data.size() < 1)
{
data.add(temp);
...
temp.add(numFormat.format(unittestss.elementAt(i).getCompleteness()));

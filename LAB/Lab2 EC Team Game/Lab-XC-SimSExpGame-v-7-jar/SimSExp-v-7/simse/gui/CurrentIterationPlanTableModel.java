...
public class CurrentIterationPlanTableModel extends AbstractTableModel
{
...
public CurrentIterationPlanTableModel(State s)
{
state = s;
...
{
temp.add(currentiterationplans.elementAt(i).getName());
}
if(data.size() < 1)
{
data.add(temp);
...
temp.add(numFormat.format(currentiterationplans.elementAt(i).getCompleteness()));

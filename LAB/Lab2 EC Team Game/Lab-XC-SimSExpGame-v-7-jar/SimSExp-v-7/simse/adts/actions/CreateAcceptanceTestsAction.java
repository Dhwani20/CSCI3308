...
import java.util.*;
public class CreateAcceptanceTestsAction extends Action implements Cloneable
{
...
public CreateAcceptanceTestsAction()
{
...
public Object clone() {
CreateAcceptanceTestsAction cl = (CreateAcceptanceTestsAction)(super.clone());
...
{
if((testss.containsKey(a)) ||( ((a instanceof AcceptanceTests) == false)) || (testss.size() >= 1))
{
return false;
}
else
...
if (oldTests instanceof AcceptanceTests) {
Artifact newTests = artifactRep.getAcceptanceTestsStateRepository().get(((AcceptanceTests)oldTests).getDescription());

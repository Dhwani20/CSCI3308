...
import java.util.*;
public class DeliverFinalProductToCustomerAction extends Action implements Cloneable
{
...
public DeliverFinalProductToCustomerAction()
{
...
public Object clone() {
DeliverFinalProductToCustomerAction cl = (DeliverFinalProductToCustomerAction)(super.clone());
...
{
if((emps.containsKey(a)) ||( ((a instanceof SoftwareDeveloper) == false) && ((a instanceof Manager) == false) && ((a instanceof CustomerRep) == false)) || (emps.size() >= 1))
{
return false;
}
else
...
else if (oldEmp instanceof Manager) {
Employee newEmp = employeeRep.getManagerStateRepository().get(((Manager)oldEmp).getName());
Boolean activeStatus = emps.get(oldEmp);
newEmps.put(newEmp, activeStatus);
}

...
import java.util.*;
public class AllEmployeesIdleAction extends Action implements Cloneable
{
private Hashtable<Employee, Boolean> emps;
private Hashtable<Project, Boolean> projs;
private int timeToLive;
public AllEmployeesIdleAction()
{
...
public Object clone() {
AllEmployeesIdleAction cl = (AllEmployeesIdleAction)(super.clone());

...
import java.util.*;
public class SetEmployeeProductivitiesAction extends Action implements Cloneable
{
private Hashtable<Employee, Boolean> emps;
private Hashtable<Project, Boolean> projs;
public SetEmployeeProductivitiesAction()
{
...
public Object clone() {
SetEmployeeProductivitiesAction cl = (SetEmployeeProductivitiesAction)(super.clone());
...
{
if((emps.containsKey(a)) ||( ((a instanceof SoftwareDeveloper) == false) && ((a instanceof Manager) == false) && ((a instanceof CustomerRep) == false)))
{
return false;
}
else

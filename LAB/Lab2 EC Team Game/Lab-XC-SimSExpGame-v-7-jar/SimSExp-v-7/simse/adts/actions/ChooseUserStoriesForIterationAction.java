...
import java.util.*;
public class ChooseUserStoriesForIterationAction extends Action implements Cloneable
{
...
public ChooseUserStoriesForIterationAction()
{
...
public Object clone() {
ChooseUserStoriesForIterationAction cl = (ChooseUserStoriesForIterationAction)(super.clone());
...
{
if((emps.containsKey(a)) ||( ((a instanceof SoftwareDeveloper) == false) && ((a instanceof CustomerRep) == false)))
{
return false;
}
else
...
else if (oldEmp instanceof CustomerRep) {
Employee newEmp = employeeRep.getCustomerRepStateRepository().get(((CustomerRep)oldEmp).getName());
Boolean activeStatus = emps.get(oldEmp);
newEmps.put(newEmp, activeStatus);
}
}
